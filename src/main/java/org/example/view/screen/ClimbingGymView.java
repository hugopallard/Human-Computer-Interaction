...
public class ClimbingGymView extends WrapperView {
    private String viewName = " Hello ClimbingGym View ";

    public ClimbingGymView(Screen screen) {
        super(screen);
    }
    ...
    public void updateView() {
        ...
        tg.putString(0, 5, "Print all members of your gym [1]");
        tg.putString(0, 6, "Add a new member [2]");
